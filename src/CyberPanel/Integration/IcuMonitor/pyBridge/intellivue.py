...
class intellivue:
    ...
    def resetValues(self):
        ...
        self.p_nbp_mean=0
        self.p_nbp_pulse=0
        self.p_nbp_inflating=0
        self.p_respiratory=0
        self.p_nbp_time=["",""]
    ...
    def get_vital_signs(self):
        ...
        ret_val.append(["NBP_inflating", self.p_nbp_inflating])
        ret_val.append(['respiratory_rate', self.p_respiratory])
    ...
    def extract_physoi_id(self, p_id, observ_val, handle_id):
        ...
        if p_id==18949:
            ...
            self.p_nbp_inflating = observ_val
        #spo2
        elif p_id==19384:
