...
interface Media {
	...
	const CMD_VOLUMEUP = 'pactl set-sink-volume 0 +5%';
	const CMD_VOLUMEDOWN = 'pactl set-sink-volume 0 -5%';
	const CMD_VOLUMEMUTE = 'pactl set-sink-mute 0 1';
	const CMD_VOLUMEUNMUTE = 'pactl set-sink-mute 0 0';
